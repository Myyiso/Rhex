...
const ADMIN_MODULE_SEARCH_ITEMS: AdminModuleSearchItem[] = [
  ...
  { href: getAdminSettingsHref("profile", "homepage"), label: "首页展示", category: "站点设置子页", description: "配置帖子链接模式、首页 feed、左右侧栏展示和搜索开关。", keywords: ["首页展示", "帖子链接显示模式", "slug模式", "id模式", "首页帖子列表形式", "画廊模式", "右侧统计卡片", "站点公告", "站内搜索", "用户主页 IP 归属地", "IP归属地", "归属地", "左侧导航", "左侧导航模式", "左侧展示模式", "隐藏左侧导航", "吸附左侧导航", "左侧默认隐藏"] },
  { href: getAdminSettingsHref("profile", "appearance"), label: "主题外观", category: "站点设置子页", description: "配置默认主题、默认字号、字号预设和五个主题预设配色。", keywords: ["主题外观", "主题预设", "字号预设", "默认主题", "默认字号", "配色", "颜色", "小号", "中号", "大号"] },
